...
<div class="wrapper row3">
  <div id="featured_slide"> 
    ...
    <ol>
      <li>
        <h2><span>Boxes</span></h2>
        <div><img src="images/home_slider/boxes.jpg" alt="" /></div>
      </li>
      <li>
        <h2><span>Warehouse</span></h2>
        <div><img src="images/home_slider/warehouse.jpg" alt="" /></div>
      </li>
      <li>
        <h2><span>Flying</span></h2>
        <div><img src="images/home_slider/airplane.jpg" alt="" /></div>
      </li>
      <li>
        <h2><span>Sorting</span></h2>
        <div><img src="images/home_slider/sorter.jpg" alt="" /></div>
      </li>
      <li>
        <h2><span>Trucking</span></h2>
        <div><img src="images/home_slider/fedex_frieght.jpg" alt="" /></div>
      </li>
    </ol>
    <!-- ####################################################################################################### --> 
  </div>
