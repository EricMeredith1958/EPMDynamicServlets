...
<div class="wrapper row1">
  <div id="header" class="clear">
    <div class="fl_left">
      <h1><a href="index.jsp">Education Time</a></h1>
...
<div class="wrapper row2">
  <div id="topnav">
    <ul>
      ...
      <li class="last"><a href="upload.html">Upload</a></li>
    </ul>
    <div  class="clear"></div>
  </div>
</div>
...
<div class="wrapper row4">
  <div id="container" class="clear"> 
    ...
    <div id="content">
      ...
      <div class="imgholder"><img src="images/dbcreate.jpg" alt="" /></div>
      ...
      <%
       ...
       out.print("<table summary=\"Summary Here\" cellpadding=\"0\" cellspacing=\"0\">");
       out.print(" <thead>");
       out.print("   <tr>");
       out.print("     <th>" + title[0] + "</th>");
       out.print("     <th>Header 2</th>");
       out.print("     <th>Header 3</th>");
       out.print("     <th>Header 4</th>");
       out.print("   </tr>");
       out.print(" </thead>");
       out.print(" <tbody>");
       out.print("   <tr class=\"light\">");
       out.print("     <td>Value 1</td>");
       out.print("     <td>Value 2</td>");
       out.print("     <td>Value 3</td>");
       out.print("     <td>Value 4</td>");
       out.print("   </tr>");
       out.print("   <tr class=\"dark\">");
       out.print("     <td>Value 5</td>");
       out.print("     <td>Value 6</td>");
       out.print("     <td>Value 7</td>");
       out.print("     <td>Value 8</td>");
       out.print("   </tr>");
       out.print(" </tbody>");
      out.print("</table>");
      %>
